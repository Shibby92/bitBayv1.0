...
public class Global extends GlobalSettings {
	...
	public void onStart(Application app) {
		...
		if (Product.find(1) == null) {
			...
			Product.create("Eminin proizvod", 2000, 1, User.find(3),
					"Neki opis", 5);
			...
			Product.create("Samsung galaxy S6 cover", 9.99, 50, User.find(3),
					"Silicon cover for Samsung galaxy S6", 3);
			...
			// Product id 12
			Product.create("Headphones for Samsung galaxy S6 ", 19.99, 100,
					User.find(3),
			...
			Product.create("Dock for Samsung galaxy S6 ", 29.99, 10,
					User.find(3),
					"Beatiful all-in-one dock for the new Samsung galaxy S6", 3);
			...
			Product.create("Dog chew rope", 5.55, 15, User.find(6),
					"A toy for your best friend!", 8);
			...
			Product.create("Dog collar", 9.69, 20, User.find(6),
					"New red plaid stylish dog collar.", 8);
			...
			Product.create("Treatball", 21.29, 5, User.find(6),
					"Mystery green rubber treatball for your dog!", 8);
			...
			Product.create("Raymond Stainless Watch", 399.00, 3, User.find(4),
