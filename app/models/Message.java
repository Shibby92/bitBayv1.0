...
public class Message extends Model{
	...
	public Message(String content, User sender, User receiver, Product p) {
		this.content = content;
		this.sender = sender;
		this.receiver = receiver;
		this.product = p;
	...
	public static Message createReport(String content, User sender, User reciever, Product p) {
		Message msg = new Message(content, sender, reciever, p);
		msg.save();
		return msg;
	}
